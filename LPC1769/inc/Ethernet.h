...
#define BASIC_STATUS_REGISTER 1 /* Physical device Basic Status Register address */
#define AUTO_NEGOTIATION_ADVERTISEMENT_REGISTER 4 /* Physical device Auto Negotiation Advertisement Register address */


#define RFC_BROADCAST_EN 1<<1 /* All broadcast frames are accepted */
#define RFC_PERFECT_EN 1<<5   /* The frames with a destination address identical to the station address are accepted */
...
#define RX_CONTROL_SIZE_MASK 0x7FF /* Mask for the size of a received frame */
...
/**
* @brief	Receives a frame from the Ethernet and stores it in a buffer
...
/**
* @brief	Writes a Ethernet frame based on the buffer received
